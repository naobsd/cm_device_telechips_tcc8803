...
#
PRODUCT_NAME := cyanogen_em73_sx
PRODUCT_BRAND := telechips
PRODUCT_DEVICE := tcc8803
PRODUCT_MODEL := EM73 SX
PRODUCT_MANUFACTURER := Emdoor
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=em73_sx BUILD_ID=GRJ22 BUILD_DISPLAY_ID=GWK74 BUILD_FINGERPRINT=google/soju/crespo:2.3.4/GRJ22/121341:user/release-keys PRIVATE_BUILD_DESC="soju-user 2.3.4 GRJ22 121341 release-keys" BUILD_NUMBER=121341
