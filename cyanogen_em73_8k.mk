...
#
PRODUCT_NAME := cyanogen_em73_8k
PRODUCT_BRAND := telechips
PRODUCT_DEVICE := tcc8803
PRODUCT_MODEL := EM73 8K
PRODUCT_MANUFACTURER := Emdoor
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=em73_8k BUILD_ID=GRK39F BUILD_DISPLAY_ID=GWK74 BUILD_FINGERPRINT=google/soju/crespo:2.3.6/GRK39F/189904:user/release-keys PRIVATE_BUILD_DESC="soju-user 2.3.6 GRK39F 189904 release-keys" BUILD_NUMBER=189904
