...
#
PRODUCT_NAME := cyanogen_inet_r_8k
PRODUCT_BRAND := telechips
PRODUCT_DEVICE := tcc8803
PRODUCT_MODEL := inet Resistive 8K
PRODUCT_MANUFACTURER := inet
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=inet_r_8k BUILD_ID=GRJ22 BUILD_DISPLAY_ID=GRJ90 BUILD_FINGERPRINT=google/soju/crespo:2.3.4/GRJ22/121341:user/release-keys PRIVATE_BUILD_DESC="soju-user 2.3.4 GRJ22 121341 release-keys" BUILD_NUMBER=121341
