...
PRODUCT_COPY_FILES += \
    device/telechips/tcc8803/init.d/10softmac:system/etc/init.d/10softmac \
    device/telechips/tcc8803/init.d/11pointercal:system/etc/init.d/11pointercal \
    device/telechips/tcc8803/etc/dhcpcd.conf:system/etc/dhcpcd/dhcpcd.conf \
    device/telechips/tcc8803/etc/vold.fstab:system/etc/vold.fstab \
    device/telechips/tcc8803/etc/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf
